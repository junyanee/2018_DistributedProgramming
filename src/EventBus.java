...
import EventPackage.RMIEventBusInterface;
 ...
 */
public class EventBus extends UnicastRemoteObject implements RMIEventBusInterface {
	 ...
	 */
	public EventBus() throws RemoteException {
		super();
	...
	/* (non-Javadoc)
	 * @see EventPackage.RMIEventBusInterface#register()
	...
	/* (non-Javadoc)
	 * @see EventPackage.RMIEventBusInterface#unRegister(long)
	...
	/* (non-Javadoc)
	 * @see EventPackage.RMIEventBusInterface#sendEvent(EventPackage.Event)
	...
	/* (non-Javadoc)
	 * @see EventPackage.RMIEventBusInterface#getEventQueue(long)
